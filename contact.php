...
<div
            ...
            <div class="contact-info text-center">
              ...
              <div class="media-body">
                ...
                <span class="contact-info_text"
                  >   2nd Floor, Krishna Prakash Arcade, 29, Main Rd, above Moti Mahal, deluxe, Govindnagar, Kadma, Jamshedpur, Jharkhand 831005
                  </span
                >
              </div>
            </div>
          ...
          <div class="col-md-6 col-lg-4">
            <div class="contact-info text-center">
              ...
              <div class="media-body">
                ...
                <span class="contact-info_text"
                  ><a href="mailto:danfitstudio2018@gmail.com"
                    >danfitstudio2018@gmail.com</a
                  >
                  <a href="tel:+918797100200">8797100200</a></span
                >
              </div>
            </div>
          </div>
    ...
    <div class="space-bottom overflow-hidden" id="contact-sec">
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="title-area mt-n1 mb-35">
              ...
              <h2 class="sec-title">Get in Touch with Danfit International</h2>
              <p class="">
                Efficiently integrate wireless value whereas cross-platform
                e-tailers.
              </p>
            </div>
            <form
              action="https://themeholy.com/html/danza/demo/mail.php"
              method="POST"
              class="contact-us-form ajax-contact"
            >
              <div class="row">
      ...
      <div
        class="shape-mockup ripple-animation d-none d-xl-block"
        data-bottom="15%"
        data-left="5%"
      >
      ...
      <div
        ...
        data-right="0%"
      >
        <img src="assets/img/shape/contact_shape.svg" alt="shape" />
      </div>
    </div>
    <div class="map-sec">
      <iframe
